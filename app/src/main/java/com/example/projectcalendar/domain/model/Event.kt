...
data class Event(
    ...
    fun hasReminder(reminders: List<Reminder>): Boolean {
        return reminders.any { it.eventId == this.id }
    }
    ...
    fun isValid(): Boolean {
        ...
        if (startDateTime == null) return false // Если у тебя startDateTime: LocalDateTime (не nullable), эту проверку можно убрать
